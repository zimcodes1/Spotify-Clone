...
const App = () => {
  return (
    <div className="bg-black h-fit w-full flex flex-wrap">
      {/*Hero Section*/}
      <div className="flex justify-evenly p-2 w-full h-screen">
        <HeroLeft />
      ...
      <div className="h-125 w-[98%] mx-auto rounded-4xl mt-1 flex flex-col justify-between items-center bg-[#16161691] overflow-hidden">
        <h1 className="text-gray-50 text-center text-5xl font-bold mt-15">Scan To Download The App</h1>
        <img src="/images/scan.png" alt="Scan QR Code" className="h-[70%]" />
      </div>

      <div className="h-fit w-[98%] mx-auto">
        <h1 className="text-gray-50 text-center text-5xl font-bold mt-15">Enhance Your Music Experience With <br /> Premium</h1>
        ...
        <div className="mt-5 w-[80%] mx-auto h-50 flex justify-between items-center">
          {/* Ad-free */}
        ...
        <h1 className="text-gray-50 text-center text-5xl font-bold mt-15">Pick Your Premium</h1>
        ...
        {/* Premium Plans */}
        <div className="w-[85%] h-100 mx-auto flex justify-evenly items-center mt-10">
          {/* Mini */}
          <div className="w-[24%] h-full flex flex-col justify-between items-start  bg-[#16161691] rounded-2xl p-4 transition duration-300 hover:scale-[1.02] cursor-pointer">
          ...
          {/* Duo */}
          <div className="w-[24%] h-full flex flex-col justify-between items-start  bg-[#16161691] rounded-2xl p-4 transition duration-300 hover:scale-[1.02] cursor-pointer border-2 border-green-500">
            <div className="w-[65%] py-2 rounded-md border border-blue-500"> <p className="text-blue-500 text-xs text-center">One-Time Plan Availaible</p></div>
            <span>
