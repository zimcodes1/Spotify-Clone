...
function HeroLeft() {
    return(
        <div className="flex flex-col justify-between items-start h-full px-15 gap-4 w-[49%] pb-[15%] pt-7 bg-[#16161691] rounded-4xl">
            <div className="w-full flex justify-start items-center">
                <img src="/images/logo.png" alt="Spotify Logo" />
                <p className="ml-2 text-xl font-bold text-gray-50">Spotify</p>
            </div>
            <span className="flex flex-col">
                <h1 className="text-4xl font-bold text-gray-50">Discover a world of music and podcasts with Spotify</h1>
                ...
                <span className="flex justify-start items-center mt-3">
                    ...
                    <p className="text-gray-400 text-sm ml">Join over 500 million Sportify <br /> users worldwide</p>
                </span>
            </span>
        </div>
    )
