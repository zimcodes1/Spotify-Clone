...
function HeroLeft() {
    return(
        <div className="flex flex-col justify-between items-start h-full max-sm:h-fit px-15 max-sm:px-5 gap-4 w-[49%] max-sm:w-full pb-[15%] pt-7 bg-[#16161691] rounded-4xl">
            <div className="w-full flex justify-start items-center">
                <img src="/images/logo.png" alt="Spotify Logo" />
                <p className="ml-2 text-xl font-bold text-gray-50">Spotify</p>
            </div>
            <span className="flex flex-col">
                <h1 className="text-4xl font-bold text-gray-50 max-sm:text-3xl">Discover a world of music and podcasts with Spotify</h1>
                ...
                <span className="flex justify-start items-center mt-3">
                    ...
                    <p className="text-gray-400 text-sm ml">Join over 500 million Sportify <br className="max-sm:hidden" /> users worldwide</p>
                </span>
            </span>
        </div>
    )
